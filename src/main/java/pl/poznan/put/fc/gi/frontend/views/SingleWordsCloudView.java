...
public class SingleWordsCloudView {
    ...
    public SingleWordsCloudView(String imageName, List<WordFrequency> wordFrequencies, List<Article> articles, String articlesLabel) throws IOException {
        ...
        controller.setArticlesList(articles);
